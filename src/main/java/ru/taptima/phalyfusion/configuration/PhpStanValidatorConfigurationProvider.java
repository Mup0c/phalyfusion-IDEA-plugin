...
public abstract class PhpStanValidatorConfigurationProvider extends QualityToolConfigurationProvider<PhpStanValidatorConfiguration> {
    private static final ExtensionPointName<PhpStanValidatorConfigurationProvider> EP_NAME = ExtensionPointName.create("ru.taptima.phalyfusion.phpStanConfigurationProvider");
